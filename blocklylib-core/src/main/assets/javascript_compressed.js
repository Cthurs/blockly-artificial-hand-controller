...
Blockly.JavaScript.lists_repeat = function (a) {
  var b = Blockly.JavaScript.provideFunction_("listsRepeat", ["function " + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + "(value, n) {", "  var array = [];", "  for (var i = 0; i < n; i++) {", "    array[i] = value;", "  }", "  return array;", "}"]), c = Blockly.JavaScript.valueToCode(a, "ITEM", Blockly.JavaScript.ORDER_COMMA) || "null";
...
Blockly.JavaScript.lists_indexOf = function (a) {
  var b = "FIRST" == a.getFieldValue("END") ? "indexOf" : "lastIndexOf", c = Blockly.JavaScript.valueToCode(a, "FIND", Blockly.JavaScript.ORDER_NONE) || "''", b = (Blockly.JavaScript.valueToCode(a, "VALUE", Blockly.JavaScript.ORDER_MEMBER) || "[]") + "." + b + "(" + c + ")";
...
Blockly.JavaScript.lists_setIndex = function (a) {
  function b() {
    if (c.match(/^\w+$/))return "";
    var a = Blockly.JavaScript.variableDB_.getDistinctName("tmpList", Blockly.Variables.NAME_TYPE), b = "var " + a + " = " + c + ";\n";
    c = a;
    return b
  }
...
Blockly.JavaScript['new_action'] = function(block) {
  ...
  var statements_finger_action = Blockly.JavaScript.statementToCode(block, 'finger_action');
  // TODO: Assemble JavaScript into code variable.
  var code =text_action+"/\n"+statements_finger_action+'\n';
  return "# "+code;
};

Blockly.JavaScript['baby_finger'] = function(block) {
  var dropdown_baby_ford = block.getFieldValue('baby_ford');
  // TODO: Assemble JavaScript into code variable.
  var isFord = 'unford';
  switch(dropdown_baby_ford){
    case "unford":
        isFord = '0';//펴기
        break;
    case "ford":
  ...
  var code = 'baby/'+isFord+"\n";
  return code;
};

Blockly.JavaScript['ring_finger'] = function(block) {
  var dropdown_ring_ford = block.getFieldValue('ring_ford');
  // TODO: Assemble JavaScript into code variable.
  var isFord = 'unford';
  switch(dropdown_ring_ford){
    case "unford":
        isFord = '0';//펴기
        break;
    case "ford":
  ...
  var code = 'ring/'+isFord+"\n";
  return code;
};

Blockly.JavaScript['middle_finger'] = function(block) {
  var dropdown_middle_ford = block.getFieldValue('middle_ford');
  // TODO: Assemble JavaScript into code variable.
  var isFord = 'unford';
  switch(dropdown_middle_ford){
    case "unford":
        isFord = '0';//펴기
        break;
    case "ford":
  ...
  var code = 'middle/'+isFord+"\n";
  return code;
};

Blockly.JavaScript['index_finger'] = function(block) {
  var dropdown_index_ford = block.getFieldValue('index_ford');
  // TODO: Assemble JavaScript into code variable.
  var isFord = 'unford';
  switch(dropdown_index_ford){
    case "unford":
        isFord = '0';//펴기
        break;
    case "ford":
  ...
  var code = 'index/'+isFord+"\n";
  return code;
};

Blockly.JavaScript['thumb'] = function(block) {
  var angle_thumb_angle = block.getFieldValue('thumb_angle');
  // TODO: Assemble JavaScript into code variable.
  var code = 'thumb/'+angle_thumb_angle+"\n";
  return code;
};
