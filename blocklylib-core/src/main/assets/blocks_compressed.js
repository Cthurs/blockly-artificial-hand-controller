...
Blockly.Blocks.lists_getIndex = {
  init: function () {
    ...
    var b = this;
    this.setTooltip(function () {
      var a = b.getFieldValue("MODE"), e = b.getFieldValue("WHERE"), d = "";
      switch (a + " " + e) {
        case "GET FROM_START":
        case "GET FROM_END":
...
Blockly.Blocks.lists_split = {
  init: function () {
    var a = this, b = new Blockly.FieldDropdown([[Blockly.Msg.LISTS_SPLIT_LIST_FROM_TEXT, "SPLIT"], [Blockly.Msg.LISTS_SPLIT_TEXT_FROM_LIST, "JOIN"]], function (b) {
      a.updateType_(b)
    });
...
Blockly.Blocks.logic_compare = {
  init: function () {
    var a = [["=", "EQ"], ["\u2260", "NEQ"], ["\u200f<\u200f", "LT"], ["\u200f\u2264\u200f", "LTE"], ["\u200f>\u200f", "GT"], ["\u200f\u2265\u200f", "GTE"]], b = [["=", "EQ"], ["\u2260", "NEQ"], ["<", "LT"], ["\u2264", "LTE"], [">", "GT"], ["\u2265", "GTE"]], a = this.RTL ? a : b;
...
Blockly.Blocks.logic_ternary = {
  init: function () {
    ...
    var b =
      this.getInputTargetBlock("THEN"), c = this.getInputTargetBlock("ELSE"), e = this.outputConnection.targetConnection;
...
Blockly.Blocks.controls_for = {
  init: function () {
    ...
    if (!this.isCollapsed()) {
      var b = {enabled: !0}, c = this.getFieldValue("VAR");
...
Blockly.Blocks.math_change = {
  init: function () {
    this.jsonInit({
      ...
      args0: [{type: "field_variable", name: "VAR", variable: Blockly.Msg.MATH_CHANGE_TITLE_ITEM}, {
        type: "input_value",
        name: "DELTA",
        check: "Number"
      }],
...
Blockly.Blocks.procedures_defnoreturn = {
  init: function () {
    ...
    if (null !== a && (a =
        "TRUE" == a, this.hasStatements_ != a))if (a)this.setStatements_(!0), Blockly.Mutator.reconnect(this.statementConnection_, this, "STACK"), this.statementConnection_ = null; else {
    ...
    a.push(b);
    if (!this.isCollapsed())for (d = 0; d < this.arguments_.length; d++)b = {enabled: !0}, c = this.arguments_[d], b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", c), e = goog.dom.createDom("field", null, c), e.setAttribute("name", "VAR"), e = goog.dom.createDom("block", null, e), e.setAttribute("type",
...
Blockly.Blocks.procedures_callnoreturn = {
  init: function () {
    ...
    var c = Blockly.Procedures.getDefinition(this.getProcedureCall(), this.workspace), e = c && c.mutator && c.mutator.isVisible();
    ...
    if (b)if (goog.array.equals(this.arguments_, a))this.quarkIds_ = b; else {
      ...
      this.updateShape_();
      if (this.quarkIds_ = b)for (d = 0; d < this.arguments_.length; d++)e =
    ...
    if (this.workspace && !this.workspace.isFlyout)if (a.type == Blockly.Events.CREATE && -1 != a.ids.indexOf(this.id)) {
      var b = this.getProcedureCall(), b = Blockly.Procedures.getDefinition(b, this.workspace);
      ...
      if (!b) {
        ...
        var c = this.getRelativeToSurfaceXY(), e = c.y + 2 * Blockly.SNAP_RADIUS;
  ...
  customContextMenu: function (a) {
    ...
    var c = this.getProcedureCall(), e = this.workspace;
    b.callback = function () {
...
Blockly.Blocks.variables_set = {
  init: function () {
    this.jsonInit({
      ...
      args0: [{type: "field_variable", name: "VAR", variable: Blockly.Msg.VARIABLES_DEFAULT_NAME}, {
        type: "input_value",
        name: "VALUE"
      }],
      previousStatement: null,
